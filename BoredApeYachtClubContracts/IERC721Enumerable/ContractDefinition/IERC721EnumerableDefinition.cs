...
namespace BoredApeYachtClubContracts.Contracts.IERC721Enumerable.ContractDefinition
{


    public partial class IERC721EnumerableDeployment : IERC721EnumerableDeploymentBase
    {
        public IERC721EnumerableDeployment() : base(BYTECODE) { }
        public IERC721EnumerableDeployment(string byteCode) : base(byteCode) { }
    }

    public class IERC721EnumerableDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IERC721EnumerableDeploymentBase() : base(BYTECODE) { }
        public IERC721EnumerableDeploymentBase(string byteCode) : base(byteCode) { }
