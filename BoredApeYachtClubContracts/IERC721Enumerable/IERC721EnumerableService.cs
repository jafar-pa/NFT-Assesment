...
using BoredApeYachtClubContracts.Contracts.IERC721Enumerable.ContractDefinition;

namespace BoredApeYachtClubContracts.Contracts.IERC721Enumerable
{
    public partial class IERC721EnumerableService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, IERC721EnumerableDeployment iERC721EnumerableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IERC721EnumerableDeployment>().SendRequestAndWaitForReceiptAsync(iERC721EnumerableDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, IERC721EnumerableDeployment iERC721EnumerableDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IERC721EnumerableDeployment>().SendRequestAsync(iERC721EnumerableDeployment);
        }

        public static async Task<IERC721EnumerableService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, IERC721EnumerableDeployment iERC721EnumerableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iERC721EnumerableDeployment, cancellationTokenSource);
            return new IERC721EnumerableService(web3, receipt.ContractAddress);
        }
        ...
        public IERC721EnumerableService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
