...
namespace BoredApeYachtClubContracts.Contracts.IERC721Metadata.ContractDefinition
{


    public partial class IERC721MetadataDeployment : IERC721MetadataDeploymentBase
    {
        public IERC721MetadataDeployment() : base(BYTECODE) { }
        public IERC721MetadataDeployment(string byteCode) : base(byteCode) { }
    }

    public class IERC721MetadataDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IERC721MetadataDeploymentBase() : base(BYTECODE) { }
        public IERC721MetadataDeploymentBase(string byteCode) : base(byteCode) { }
