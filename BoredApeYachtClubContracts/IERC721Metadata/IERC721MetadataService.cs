...
using BoredApeYachtClubContracts.Contracts.IERC721Metadata.ContractDefinition;

namespace BoredApeYachtClubContracts.Contracts.IERC721Metadata
{
    public partial class IERC721MetadataService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, IERC721MetadataDeployment iERC721MetadataDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IERC721MetadataDeployment>().SendRequestAndWaitForReceiptAsync(iERC721MetadataDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, IERC721MetadataDeployment iERC721MetadataDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IERC721MetadataDeployment>().SendRequestAsync(iERC721MetadataDeployment);
        }

        public static async Task<IERC721MetadataService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, IERC721MetadataDeployment iERC721MetadataDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iERC721MetadataDeployment, cancellationTokenSource);
            return new IERC721MetadataService(web3, receipt.ContractAddress);
        }
        ...
        public IERC721MetadataService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
